## 📺 YoutubeDownloader — Blazor Application (.NET 8)

**YoutubeDownloader** is a .NET application built with **Blazor (.NET 8)** for viewing and downloading YouTube video and audio streams using [YoutubeExplode](https://github.com/Tyrrrz/YoutubeExplode) and [FFmpeg](https://ffmpeg.org/).
